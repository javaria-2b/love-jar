          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                height: '64px',
                borderRadius: '50%',
                background: 'linear-gradient(135deg, var(--wax-red), var(--wax-red-light))',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                boxShadow: '0 4px 16px rgba(139, 0, 0, 0.2), inset 0 2px 4px rgba(255,255,255,0.2)',
                position: 'relative',
              }}
            >
              {/* Wax seal inner ring */}
              <div style={{
                ...
                <span style={{ fontSize: '24px', filter: 'drop-shadow(0 1px 2px rgba(0,0,0,0.3))' }}>♥</span>
              </div>
              {/* Seal ribbon */}
              <motion.div
            ...
            <div>
              ...
              <p style={{
                ...
                sealed with love since {getTimeOfDay()}
              </p>
            </div>
            ...
            >
              <Sparkles size={18} />
              {memoriesCount > 0 ? 'reveal today\'s memory' : 'add some memories first'}
            </motion.button>
          </motion.div>
        )}
      </AnimatePresence>
